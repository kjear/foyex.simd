...
TODO:
  1. Improve the functions related to floating-point operations
  2. Add support for complex numbers
  3. Add support for AVX512
  4. Remove the dependency on the unique API of the MSVC compiler for the Windows platform
  5. Optimize the performance of existing functions implemented by composite instructions
