...
{ \
    ...
    DEF_NOSUITABLE_IMPLEMENT__HMUL(std::uint64_t hmul(uint8x16 input))
        ...
        DEF_NOSUITABLE_IMPLEMENT__HMUL(std::uint64_t hmul(sint8x16 input))
        DEF_NOSUITABLE_IMPLEMENT__HMUL(std::uint64_t hmul(sint16x8 input))
        DEF_NOSUITABLE_IMPLEMENT__HMUL(std::uint64_t hmul(sint32x4 input))
        DEF_NOSUITABLE_IMPLEMENT__HMUL(std::uint64_t hmul(sint64x2 input))
        ...
        DEF_NOSUITABLE_IMPLEMENT__HMUL(std::uint64_t hmul(sint8x32 input))
        DEF_NOSUITABLE_IMPLEMENT__HMUL(std::uint64_t hmul(sint16x16 input))
        DEF_NOSUITABLE_IMPLEMENT__HMUL(std::uint64_t hmul(sint32x8 input))
        DEF_NOSUITABLE_IMPLEMENT__HMUL(std::uint64_t hmul(sint64x4 input))
